...
class Stemmer {
	 ...
	 * (j < 500) j++; ch = in.read(); if (!Character.isLetter((char) ch)) { /*
	 * to test add(char ch)
	 */
	...
	// break;
	/*
	 * } } } if (ch < 0) break; System.out.print((char)ch); } } catch
	 * (IOException e) { System.out.println("error reading " + args[i]); break;
	 * } } catch (FileNotFoundException e) { System.out.println("file " +
	 * args[i] + " not found"); break; } }
	 */
	...
	public static void porterMain(String[] stemFile) throws IOException {
		...
		for (int i = 0; i < stemFile.length; i++)
			try {
				...
				FileWriter targetFileWriter = new FileWriter(stemFile[i]
						+ "stemed");
